...
export default function ContactUs() {
  return (
    <div className="contactus-container">
      ...
      <div className="row m-0 get-in-touch">
        <div className="col-md-6 pe-5">
          ...
          >
            ...
            <button type="submit" className="button mt-2" data-aos="fade-up">
              Send Message
            </button>
          </form>
        </div>
        <div className="col-md-6 ps-4">
          <p className="main-title" data-aos="fade-left">
            Get In Touch
          </p>
          ...
          <div className="row m-0 mb-4 contact-details-wrapper">
            ...
            <div className="col-md-6 ps-0 row m-0" data-aos="fade-up-left" data-aos-offset="160">
              <div className="col-md-4 ps-0">
                <div className="icon-wrapper">
                  <img src="/images/office-building.svg" alt="location" className="w-45" />
                </div>
              </div>
              <div className="col-md-8">
          ...
          <div className="row m-0 contact-details-wrapper">
            <div className="col-md-6 ps-0 row m-0" data-aos="fade-up-left">
              <div className="col-md-4 ps-0">
                <div className="icon-wrapper">
                  <img src="/images/phone-call.svg" alt="location" className="w-40" />
                </div>
              </div>
              <div className="col-md-8">
                <h5 className="font-Kanit fs-semi-large">Call Us</h5>
                <p className="mb-0">
                  <a href="tel:7722968126" className="color-252525">(+91) 77229 68126</a>
                </p>
              </div>
            </div>
            <div className="col-md-6 ps-0 row m-0" data-aos="fade-up-left" data-aos-offset="160">
              <div className="col-md-4 ps-0">
                <div className="icon-wrapper">
                  <img src="/images/mail.svg" alt="location" className="w-40" />
                </div>
              </div>
              <div className="col-md-8">
                <h5 className="font-Kanit fs-semi-large">Email Address</h5>
                <p className="mb-0">
                  <a href="mailto:support@sublineautorob.com" className="color-252525">
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15084.029653017482!2d72.8518560727656!3d19.063411674512952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c8df0b86ea1b%3A0xce7eea4b1bbdf296!2sBandra%20Kurla%20Complex%2C%20Bandra%20East%2C%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1675068838817!5m2!1sen!2sin" loading="lazy" title="office-location" className="d-block w-100 h-450px"></iframe>
    </div>
  );
}
